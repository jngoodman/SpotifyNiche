...
class Bar:
    ...
    def determine_title_suffix(self):
        ...
        list_of_display_ready_terms = [
            GRAPH.DISPLAY_KEY_DICT[term] for term in self.terms
        ]
        logic_dict = {
            1: f"{list_of_display_ready_terms[0]}",
    ...
    def adjust_labels(self):
        ...
        plt.title(
            f"Top Artists by Popularity [{self.determine_title_suffix()}]",
